import { AdUnits, CloudCircle, Delete, DiscountRounded } from "@mui/icons-material";
import {
  deleteObject,
  getDownloadURL,
  ref,
...
import Loader from './Loader';
  ...
  const CreateSlide = () => {
    const {slideItems,setSlideItems} = useGlobalContext();
      ...
      <div className="w-full h-auto md:h-550 bg-gray-100  flex items-center justify-center ">
        <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg flex flex-col items-center justify-center">
          ...
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
            <AdUnits className="text-xl text-gray-700" />
            <input
              type="text"
              required
              value={title}
                  ...
                  <>
                    <label className="w-full h-full flex flex-col items-center justify-center cursor-pointer">
                      <div className="w-full h-full flex flex-col items-center justify-center gap-2">
                        <CloudCircle className="text-gray-500 text-3xl hover:text-gray-700 py-6" />
          ...
          <div className="w-full flex flex-col md:flex-row">
            ...
            "
            >
              <DiscountRounded className="text-xl text-gray-700" />
              <input
                type="text"
                required
                value={discount}
